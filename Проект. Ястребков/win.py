...
from testWindow import StartWidget, TestWidget1, TestWidget2, TestWidget3, TestWidget4, EndWidget
...
class ModalLogin(QWidget):
    ...
    def add_layouts(self):
        ...
        self.testWidget4 = TestWidget4(lambda: self.next_clicked4())
        ...
        self.stackLayout.addWidget(self.testWidget4)
    ...
    def next_clicked4(self):
        if self.testWidget4.rb1.isChecked() and self.testWidget4.rb2.isChecked() and self.testWidget4.rb3.isChecked() and self.testWidget4.rb4.isChecked() and self.testWidget4.rb5.isChecked() and self.testWidget4.rb6.isChecked():
